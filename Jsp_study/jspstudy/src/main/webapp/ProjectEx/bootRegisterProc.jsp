...
<body>
	...
	<!-- 
	 ...
	 -->
	<jsp:useBean id="sDao" class="JobDb.JobDao" scope="application"></jsp:useBean>
	<%
		JobDo sdo = new JobDo();
		sdo.setName(request.getParameter("name"));
		sdo.setDay(request.getParameter("day"));
		sdo.setPer(request.getParameter("per"));
		sdo.setJob(request.getParameter("job"));
